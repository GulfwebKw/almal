...
class AdminCategoryCountryController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->model = '\App\Category_country';
        $this->title = 'category countrey';
        $this->path = 'categorycountrey';
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:country_resume,display_order',
    ...
    $request->image->move(public_path('uploads/categorycountrey'), $image);
    }
