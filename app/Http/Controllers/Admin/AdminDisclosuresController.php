...
class AdminDisclosuresController extends Controller
{
    public $settings;
    public $model;
    public $path;
    ...
    public function __construct()
    {
        ...
        $this->model = '\App\Disclosure';
        $this->title = 'Disclosure';
        $this->path = 'disclosures';
    ...
    public function update(Request $request, $id)
    {
        ...
        $images = array_merge($images, $request->images);
        $images = implode(',', $images);
            }else
        $images = implode(',', $request->images);
        }
        $resource->slug = Common::createSlug('Disclosure', $request->title_en, $id);
        $resource->title_en = $request->input('title_en');
        $resource->date = $request->input('date');
        $resource->title_ar = $request->input('title_ar');
        $resource->image = $cover_image;
