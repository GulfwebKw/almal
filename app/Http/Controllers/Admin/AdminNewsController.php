...
class AdminNewsController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        //field validation
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:news_tbl,display_order,' . $id,
            'title_en' => 'required|string',
            'title_ar' => 'required|string',
        ...
        if (isset($request->images) && count($request->images) > 0) {
            ...
            if ($resource->images == null) {
                ...
                $images = array_merge($request->images, explode(',', $resource->images));
    ...
    public function storeNews(Request $request)
    {
        ...
        //field validation
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:news_tbl,display_order',
            'title_en' => 'required|string',
            'title_ar' => 'required|string',
            'description_en' => 'required|string',
            'description_ar' => 'required|string',
