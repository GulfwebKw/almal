...
class AdminSubsidiariesController extends Controller
{
    public $settings;
    public $model;
    public $path;
    ...
    public function __construct()
    {
        ...
        $this->model = '\App\Subsidiary';
        $this->title = 'Subsidiaries and Associates';
        $this->path = 'subsidiaries';
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:subsidiaries,display_order',
            'comapy_name' => 'required|string',
        ]);
        //upload image
        ...
        $resource->comapy_name = $request->input('comapy_name');
    ...
    {
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:subsidiaries,display_order,' . $id,
            'comapy_name' => 'required|string',
