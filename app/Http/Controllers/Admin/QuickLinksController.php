...
class QuickLinksController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->model = '\App\QuickLink';
        $this->title = 'Quick links';
        $this->path = 'quicklinks';
    ...
    {
        $resources = $this->model::with('category')->orderBy('display_order', $this->settings->default_sort)->paginate($this->settings->item_per_page_back);
    ...
    {
        $categories_custom = Category::where('is_active',1)->where('parent_id', '!=', null)->get();
    ...
    public function store(Request $request)
    {
        ...
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:quick_links,display_order',
            'category_id' => 'required',
        ]);
        $resource = new QuickLink();
    ...
    public function update(Request $request, $id)
    {
        //field validation
        $this->validate($request, [
            'display_order' => 'required|numeric|unique:quick_links,display_order,' . $id,
            'category_id' => 'required',
        ]);
        $resource = $this->model::find($id);
        $resource->title_en = $request->input('title_en');
