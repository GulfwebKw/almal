...
class ServiceController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('icon')){
            $image = Common::editImage($request, 'icon', $this->path, $this->image_big_w, $this->image_big_h, $this->image_thumb_w, $this->image_thumb_h, $resource);
        }
    ...
    public function insertSerives(Request $request)
    {
        //field validation
        $this->validate($request, [
        ...
        $image = "";
        if ($request->hasFile('icon')){
        $image = Common::uploadImage($request, 'icon', $this->path, $this->image_big_w, $this->image_big_h, $this->image_thumb_w, $this->image_thumb_h);
        }
