...
class AdminSettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            'social_google_plus' => 'nullable|string',
        ...
        $footer_logo = Common::editImage($request, 'footer_logo', $this->path, $this->image_big_w, $this->image_big_h, $this->image_thumb_w, $this->image_thumb_h, $resource);
        ...
        $resource->social_instagram = $request->input('social_instagram');
