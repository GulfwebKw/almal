...
@section('content')
    ...
    <style>
        ...
        .subscription-head{
            color: #072438; font-family: Roboto;    font-size: 26px;    font-weight: bold;  line-height: 32px;
        }
        ...
        .subscription-page .month-plan{
            color: #072438; font-size: 20px;    font-weight: bold;  line-height: 32px;
        }
        .subscription-page .activate-plan{
            ...
            margin-left: 30px;
            color: #FFFFFF; font-size: 12px;    font-weight: bold; border-radius: 14px;
        }
        ...
        .subscription-page .cost{
            color: #55C9D1; font-size: 14px;    font-weight: 500;   line-height: 32px;
        }
        .subscription-page .kd-month{
            color: #072438; font-size: 40px;    font-weight: bold;  line-height: 66px;
        }
        .subscription-page .per-month{
            color: #072438; font-size: 14px;    font-weight: bold;  line-height: 32px;
        }
        .subscription-page .expiration{
            color: #EF666E; font-size: 16px;    font-weight: bold;  letter-spacing: -0.35px;    line-height: 19px;
        }
        ...
        .active-plan,.activate-plan:hover{
            cursor: pointer;
        }
                    ...
                    <div class=" text-center plans">
                        <div class="subscription-box">
                            <div class="same-line">
                                ...
                                <div class="button-active"> <button class="activate-plan">Activate</button> </div>
                                @endif

                            </div>
                            <p class="kd-month">KD {{number_format($package->price, 2, '.', '')}} <!-- <span class="per-month">/per-month</span> --></p>
                            @if($package->id ==auth()->user()->package_id && isset($expire) && $expire >= Carbon::now()->toDateString())
