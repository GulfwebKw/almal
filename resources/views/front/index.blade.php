...
<!--[if lte IE 9]>
        ...
        <section id="wrapper">
                        ...
                        <div class="container">
                            ...
                            <div class="menu">
                                ...
                                <nav id="navigation" class="main-nav ">
                                    <a aria-label="mobile menu" class="nav-toggle"> <span></span> <span></span>
                                        <span></span>
                                    </a>
                                    <ul id="nav" class="menu-left">
                                        ...
                                        @if(!(Auth::guard('freelancer')->check() || Auth::guard('admin')->check()))
                                            ...
                                            <li>
                                                <a href="{{route('login.index')}}">{{$lang=='en'?'Login/SignUp':'الفوائد'}}</a>
                                            </li>
                                        @endif
                                        ...
                                        <article class="abt-left-bg">
                                            ...
                                            <article class="abt-right" data-aos="fade-down"
                                                ...
                                                <div class="phone-right"><img
                                                            src="{{asset('front_assets/assets/images/phone-right.png')}}">
                                                </div>
                                            </article>
                                        </article>
                                    </section>
                                    ...
                                    <ul>
                                        <div class="bloc bloc-head" style="display:none;">
                                            <svg height="300" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                                                 viewBox="0 0 408.7 354" enable-background="new 0 0 408.7 354"
                                                 id="hi-there"
                                ...
                                <section class="container">
                                    <article class="benefits-box">
                                        ...
                                        <div class="benefits-box-right">
                                            <h5 class="left"
                                                data-delighter="start:0.8">{{$lang=='en'?'BENEFITS':'الفوائد'}}</h5>
                                            ...
                                            <h2 class="left"
                                                data-delighter="start:0.8">{{$lang=='en'?'Expansion':'التوسع'}}</h2>
                                            <div class="left"
                                                 data-delighter="start:0.8"> {!! getSingle('expansion')['details_'. $lang]!!} </div>
                                        </div>
                                    </article>
                                </section>
                            </section>
                                ...
                                <section class="container">
                                    <article class="col-center right" data-delighter="start:0.8">
                                        <div class="logo-btm main-nav "><a href="index-2.html"> <img
                                                        src="{{asset('/uploads/settings/'.$settings->logo)}}"> </a>
                                        </div>
                                        <h6>Get in touch</h6>
                                        <h3 style="padding-bottom: 20px;"><a
                                                    href="mailto:info@dealsco.app">{{$settings->email}}</a></h3>
            ...
            <footer>
                <section class="container">
                    <p>© 2019 Deals. All rights reserved. </p>
                </section>
            </footer>
        </section>
@endsection