                    ...
                    <div class="col-md-5">
                            ...
                            <select name="parent_id" class="form-control">
                                ...
                                @if(count($category->childrenRecursive)>0)
                                        @include('gwc.partials.Editcategory',['children' => $category->childrenRecursive, 'parent_id'=>$resource->parent_id, 'notSelectable'=>$childrenIds, 'level'=>0,'category_id'=>$resource->parent_id])
                                    @endif
                                @endforeach
                            </select>
                    </div>
