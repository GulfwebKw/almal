...
<head>
    ...
    <meta charset="utf-8"/>
    <title>{{__('adminMessage.websiteName')}}|Category List</title>
...
<!-- begin::Body -->
<body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixe kt-page--loading">
                    ...
                    <div class="kt-container  kt-container--fluid ">
                        <div class="kt-subheader__main">
                            ...
                            <div class="kt-subheader__breadcrumbs">
                                ...
                                <a href="javascript:;" class="kt-subheader__breadcrumbs-link">Category Listing</a>
                        ...
                        <div class="kt-subheader__toolbar">
                            <form class="kt-margin-l-20" id="kt_subheader_search_form">
                                <div class="kt-input-icon kt-input-icon--right kt-subheader__search">
                                    <input type="text" class="form-control" placeholder="Search..." id="searchCat"
                                           name="searchCat">
                            ...
                            <div class="btn-group">
                                @if(auth()->guard('admin')->user()->can('category-create'))
                                    <a href="{{url('gwc/category/create')}}" class="btn btn-brand btn-bold"><i
                                    ...
                                    <div class="kt-list-timeline">
                                        <div class="kt-list-timeline__items">
                                            <div class="kt-list-timeline__item">
                                                ...
                                                <span class="kt-list-timeline__text">Category name</span>


                                                <span class="kt-list-timeline__time">image</span>
                                                <span class="kt-list-timeline__time">staus</span>
                                                <span class="kt-list-timeline__time text-center">display order</span>

                                                <span class="kt-list-timeline__time">active</span>
                                            </div>
                                            @foreach($categories as $category)
                                                <div class="kt-list-timeline__item">

                                                    <span class="kt-list-timeline__text"><h5
                                                                style="color: blue">{{$category->name_en}}</h5></span>
      ...
      aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											<h6 class="modal-title text-left">Do you want delete category</h6>
										</div>
										<div class="modal-footer">
											<button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">no</button>
											<button type="button" class="btn btn-danger"
                                                    onClick="Javascript:window.location.href='{{url('gwc/category/delete/'.$category->id)}}'">yes</button>
										</div>
									</div>
								</div>
							</div>
                            ...
                            @else
                                <div class="alert alert-light alert-warning" role="alert">
                                    ...
                                    <div class="alert-text">You do not have perssion</div>
                                </div>
                        @endif
                        <!--end: Datatable -->
                        </div>
