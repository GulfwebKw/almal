...
@section('indexContent')
    <table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
        ...
        <tr>
            ...
            <th>phone</th>
            <th>fax</th>
            <th>client complaints details (en)</th>
            <th>client complaints details (ar)</th>
        ...
        @if(count($resources))
            ...
            @foreach($resources as $resource)
                <tr class="search-body">
                    ...
                    <td>
                        {!! \Illuminate\Support\Str::limit($resource->description_en , 50)!!}
                    </td>
                    <td>
                        {!! \Illuminate\Support\Str::limit($resource->description_ar, 50) !!}
                    </td>
