                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <select name="type" class="form-control" required >
                            <option @if($resource->type=="NEWS") selected @endif value="NEWS">NEWS</option>
                            <option @if($resource->type=="EVENT") selected @endif value="EVENT">EVENT</option>
                        </select>
                    </div>
                </div>
            </div>
                        ...
                        <ul class="pic">
                            @foreach(explode(',', $resource->images) as $image)
                                <li data-e="{{$image}}">
                                    ...
                                    <img width="150" src="{{asset("/uploads/news/". $image)}}" alt="">
                                </li>
                            @endforeach
                        </ul>
                    @endif
    ...
    <script type="text/javascript">
        ...
        function DeletePic(name) {
            $.ajax({
                ...
                method: 'POST',
                data: {name: name, id: '{{$resource->id}}', model: 'News'},
