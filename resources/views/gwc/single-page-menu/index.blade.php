...
@section('indexContent')
    <table class="table table-striped- table-bordered table-hover table-checkable " id="kt_table_1">
        ...
        <tr>
            ...
            <th width="100">{{__('adminMessage.og_category')}}</th>
        ...
        @if(count($resources))
            ...
            @foreach($resources as $resource)
                <tr class="search-body">
                    ...
                    <td width="40%">
                        {{html_entity_decode(\Illuminate\Support\Str::limit(strip_tags($resource->description_en), 100, '...'))}}
                    </td>
                    <td>
                        {!! $resource->display_order !!}
                    </td>
                    <td>
                        <img src="{{asset('/uploads/single-page-menu/'. $resource->image)}}" width="30px">
                    </td>
                    <td>
